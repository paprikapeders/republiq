    ...
    return (
        <div className="min-h-screen bg-[#0f0f1e]">
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                {/* Team Header */}
                <div className="bg-[#1a1a2e] border border-[#16213e] mb-8 overflow-hidden rounded-lg">
                ...
                {players.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {players.map((player) => (
                            <div key={player.id} className="bg-[#1a1a2e] border border-[#16213e] overflow-hidden rounded-lg">
                                ...
                                <div className="p-5">
                                    ...
                                    <p className="text-sm text-gray-400 mb-4">#{player.id}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="bg-[#1a1a2e] border border-[#16213e] p-12 text-center rounded-lg">
                        <p className="text-gray-400">No players registered for this team yet.</p>
                    </div>
                )}
            </div>
        </div>
