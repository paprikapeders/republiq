                    ...
                    <div className="text-center bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6">
                        <div className="flex items-center justify-center gap-3 mb-2">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-blue-100 text-sm">Queens Ballers Republiq</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="text-sm">
                                        ...
                                        <div className="mt-2 p-3 bg-[#0f0f1e] border border-[#16213e] rounded-md text-xs text-gray-400 max-h-32 overflow-y-auto">
                                            ...
                                            <p className="mb-2">
                                                <strong>RELEASE OF LIABILITY:</strong> In consideration of being allowed to participate in the Queens Ballers Republiq activities, I hereby release, waive, discharge, and covenant not to sue the Queens Ballers Republiq, its organizers, officials, coaches, volunteers, sponsors, and facilities from any and all liability, claims, demands, actions, and causes of action whatsoever arising out of or related to any loss, damage, or injury that may be sustained while participating in league activities.
                                            </p>
                                            <p className="mb-2">
                                                <strong>MEDICAL TREATMENT:</strong> I authorize the Queens Ballers Republiq representatives to seek emergency medical treatment on my behalf if necessary, and I assume full responsibility for any medical expenses incurred.
                                            </p>
                                            <p className="mb-2">
